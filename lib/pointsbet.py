...
def _parse(queue):
    ...
    old_data = driver.find_elements(By.XPATH, '//div[@class="f3wis39"]')
    while True:
        
        try:
            new_data = driver.find_elements(By.XPATH, '//div[@class="f3wis39"]')
            if new_data != old_data:
                ...
                queue.put(("pointsbet", output))

            old_data = new_data
            time.sleep(1)

        except Exception as e:
            print(f"An error occurred in pointsbet: {e}")
